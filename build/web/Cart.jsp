<%-- 
    Document   : Detail
    Created on : Jun 29, 2023, 11:07:02 PM
    Author     : quang
--%>
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">TOTAL</strong>
                                            ...
                                            <strong>${sessionScope.cart.total} $</strong></li>
                                        </c:if>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">SHIPPING</strong>
                                            <c:if test="${sessionScope.cart != null}"> 
                                                <strong>Free ship</strong></li>
                                            </c:if>
                                    ...
                                    </ul><a href="buy" class="btn btn-dark rounded-pill py-2 btn-block">PLACE ORDER</a>
                                </div>
                            </div>
                        </div>
